...
public class WrongConfigurationGroup {
    ...
    public static void initialize() throws UnknownHostException
    {
        ...
        doc = new BasicDBObject("groupname", "doit").append("users", "tester1").append("description", "123");
        db.getCollection("chatgroups").insert(doc);
...
//                driver.findElement(By.cssSelector(".nav > li:nth-child(6) > a:nth-child(1)")).click();
                ...
                driver.findElement(By.id("GroupName")).sendKeys("doit");
                Thread.sleep(1000);
                driver.findElement(By.id("description")).clear();
                driver.findElement(By.id("description")).sendKeys("HelloWorld");
                  Thread.sleep(1000);
                System.out.println(driver.getPageSource().contains("Group already exists"));
                ...
                driver.findElement(By.id("user1")).sendKeys("tester23");
                driver.findElement(By.xpath("//div[6]/button")).click();
                Thread.sleep(1000);
                System.out.println(driver.getPageSource().contains("User not Exist"));
